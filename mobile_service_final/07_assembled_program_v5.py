...
class NewJob:
    def __init__(self):
        ...
        self.error_success_label = Label(self.input_frame, text="", font="Arial 14", justify="left")
            ...
            try:
                ...
                try:
                    ...
                    try:
                        ...
                        if virus_time < 0:
                            raise ValueError
                        elif virus_time == 0.0 and not wof_tune:
                            raise ValueError
                    except ValueError:
                        self.error_success_label.configure(text="Virus protection time should be a number above or equal to 0. \n"
                                                                "Virus protection time cannot be 0 if no general 'wof and tune' \n"
                                                                "service was required (and vice versa).",
                                                           bg="#FF4B38", fg="white")
                    else:
